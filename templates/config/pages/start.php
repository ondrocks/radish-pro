...
<tr><td colspan='2'><p><?php echo PText::getString('Import_connections', 
					array(
						...
						"<a href='?page=gmail'>Gmail</a>"));?></p><?php echo PText::getString('Explain_email', array('<a href="https://__url__' . controllerFront::getController() . '/">', '</a>'));?></p></td></tr>
...
<tr><td class='taright' colspan='2'>&copy; <?php echo PText::getString('Copyright');?></td></tr>
<form>
</table>
